            ...
            <div class="col-md-6 my-auto">
                <div class="mt-4 mb-4">
                    <div class="justify">
                        ...
                        <h2 class="app-brand-text text-body fw-bolder ">Tabel Data Masyarakat</h2>
                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center mt-3 mb-3">
                        <div class="text-center">
                            <h3 class="app-brand-text text-body fw-bolder">Data Masyarakat</h3>
                            <h6 class="card-subtitle text-muted">Berikut adalah masyarakat suka ngeluh yang terdaftar</h6>
                        </div>
                    </div>
                    ...
                    <div class="position-relative">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <!-- form search -->
                            <form action="data_masyarakat.php" method="GET">
                            ...
                            <div>
                                <a href="export_masyarakat.php" type="button" class="btn rounded-pill btn-icon btn-outline-info" fdprocessedid="uv3qr4"><span class="tf-icons bx bx-printer" target="_blank"></span></a>
                                <!-- trigger Tambah -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel2">Tambah Data Masyarakat</strong></h5>
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn rounded-pill btn-primary" name="kirim" href="index.php?page=masyarakat">Daftar</button>
                                                </div>
                                            </form>
                                            <?php
                                            include '../config/koneksi.php';
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['cari'])) {
                                    $pencarian = $_GET['cari'];
                                    $query_cari = "SELECT * FROM tbl_masyarakat WHERE nik LIKE '%" . $pencarian . "%' or nama LIKE '%" . $pencarian . "%' or username LIKE '%" . $pencarian . "%' or telp LIKE '%" . $pencarian . "%'";
                                } else {
                                    $query_cari = "SELECT * FROM tbl_masyarakat ORDER BY nama DESC";
                                }
                                ...
                                while ($data = mysqli_fetch_array($tampil)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- triger hapus -->
                                            <button type="button" class="btn btn-sm rounded-pill btn-outline-danger" data-bs-toggle="modal" data-bs-target="#hapusModal<?php echo $data['nik'] ?>"><span class="tf-icons bx bx-trash"></span></button>

                                            <!-- hapus modal -->
                                            <div class="modal fade" id="hapusModal<?php echo $data['nik'] ?>" tabindex="-1" style="display: none;" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="edit_data.php" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        ...
                                                                        <strong> USER : <?php echo $data['nama'] ?></strong> secara <strong>PERMANEN</strong>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn rounded-pill btn-outline-danger" name="hapus_masyarakat">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
